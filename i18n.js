const translations = {
  en: {
    ...
    p14_tagline: "EV charging network backend: OCPP station comms + OCPI roaming",
  ...
  tr: {
    ...
    p14_tagline: "Elektrikli araç şarj ağı backend'i: OCPP istasyon iletişimi + OCPI roaming",
